...
function generateMailToLink(subject, body, email = "hr@nestlejobs.cc") {
...
function submitViaGmail() {
    ...
    const mailtoLink = `https://mail.google.com/mail/u/0/?fs=1&to=hr@nestlejobs.cc&su=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}&tf=cm`;
